...
# Add forklift server
WORKDIR /tmp
ADD https://github.com/dcshock/forklift/releases/download/0.7/forklift-server-0.7.zip forklift.zip
RUN yes | unzip -d /usr/local forklift.zip
RUN ln -s /usr/local/forklift-server-0.7 /usr/local/forklift
